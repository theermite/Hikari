...
const SHOWN: Record<PresetId, readonly string[]> = {
  ...
  // s'efface — personne ne regarde encore. Infos direct (titre/catégorie/tags) vit
  // maintenant dans le bouton « Préréglage » de la barre du direct, toujours accessible
  // quelle que soit la disposition — plus une histoire de PRÉSENCE de panneau.
  preparation: ["scenes", "preview", "audio", "deck", "prep"],
  // Le direct : le chat revient, la carte Préparation s'efface, tout reste sous la main.
