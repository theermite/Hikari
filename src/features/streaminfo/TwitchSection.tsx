// Volet Twitch — titre, catégorie, tags (F-054). Sorti du panneau cockpit fixe
// « Infos direct » le 2026-09-19 (Jay : « ça encombre l'interface ») vers le menu
// « Préréglage » de la barre du direct (`LiveBar.tsx`) — même contenu, juste plus
// disponible à la demande qu'affiché en permanence.
...
export function TwitchSection() {
  ...
  // Une seule instance sur toute la vie du composant : recréée à chaque rendu, `debounce`
