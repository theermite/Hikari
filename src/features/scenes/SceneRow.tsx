 ...
 * plafond BLOQUANT de 500 (Quality.md). Le JSX est repris tel quel ; toutes les fonctions
 * qui touchaient l'état du panneau deviennent des propriétés — ce composant n'a plus aucun
 * état propre, tout vit dans ScenesPanel.
 */
